...
// called.
func (hp *DNSHostProvider) Next() (server string, hostname string, retryStart bool) {
        hp.mu.Lock()
        defer hp.mu.Unlock()
        ...
        return hp.servers[hp.curr], hp.hostnames[hp.curr], retryStart
}
